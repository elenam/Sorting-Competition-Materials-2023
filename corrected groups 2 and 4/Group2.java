...
public class Group2 {
	...
	private static void sort(String[] toSort) {
		//System.out.println("size = " + SortingCompetitionComparator.getSize());
		SortingCompetitionComparator.initHashMap();
...
//    	return primeFactorSumCache.size();
//    }

    public static void initHashMap() {
    	primeFactorSumCache = new HashMap<>();
    }
