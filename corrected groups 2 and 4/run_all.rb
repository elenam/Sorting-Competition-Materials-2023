### the script for running the UMN Morris CSci sorting competition 
...
groups = 8 # number of groups (including group 0 which is the sample sorting)
inFileNames = ["final1.txt", "final2.txt", "final3.txt"]
runTimes = []
sortedTimes = []
